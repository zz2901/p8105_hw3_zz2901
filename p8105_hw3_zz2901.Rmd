...
* The `ny_noaa` has `r nrow(ny_noaa)` observations and `r ncol(ny_noaa)` variables. The variables are `id`, `date`, `prcp`, `snow`, `snwd`, `tmax`, and `tmin`, and variable types `chr`, `date`, `int`,  `int`,  `int`, and  `int` correspondingly. 
