...
-   The `ny_noaa` has 2595176 observations and 7 variables. The
    ...
    `tmin`, and variable types `chr`, `date`, `int`, `int`, `int`, and
    `int` correspondingly.

-   We noticed that there are many missing data for the last five
    numeric measures.
...
<span style="color:#36648B;font-weight:700"> \* yes
